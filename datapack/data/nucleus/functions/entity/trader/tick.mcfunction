...
execute if entity @s[tag=nucleus.trader_entity.tint_based] run function nucleus:entity/trader/tick/tint
...
data modify entity @s[predicate=nucleus:entity/moving,tag=!nucleus.no_movement] HandItems[0].tag.CustomModelData set from entity @s ArmorItems[3].tag.nucleus.custom_model_data.moving
