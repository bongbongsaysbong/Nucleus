...
data modify entity @s[predicate=nucleus:entity/moving,tag=!nucleus.no_movement] ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.nucleus.custom_model_data.moving
