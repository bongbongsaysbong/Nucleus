...
execute as @e[type=#nucleus:preset/can_take_damage/mobs,tag=nucleus.arthropod_damage,nbt={HurtTime:10s}] run function nucleus:entity/technical/arthropod/as_entity
