...
execute as @e[type=#nucleus:preset/can_take_damage/mobs,tag=nucleus.entity.smite_damage,nbt={HurtTime:10s}] run function nucleus:entity/technical/smite/as_entity
