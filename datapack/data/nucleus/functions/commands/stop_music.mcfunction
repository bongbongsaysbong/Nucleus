...
stopsound @s music minecraft:music.overworld.bamboo_jungle
...
stopsound @s music minecraft:music.overworld.under_water

function #nucleus:event/player/stop_music
