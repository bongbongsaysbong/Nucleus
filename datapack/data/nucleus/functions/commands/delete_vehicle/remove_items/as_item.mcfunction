...
execute store result score #rng_x nucleus.dummy run random value 1..4 nucleus:rng/1..4
execute store result score #rng_y nucleus.dummy run random value 1..4 nucleus:rng/1..4
execute store result score #rng_z nucleus.dummy run random value 1..4 nucleus:rng/1..4
